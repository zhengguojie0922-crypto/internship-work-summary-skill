...
class SkillContractTests(unittest.TestCase):
    ...
    def test_final_document_has_resume_narratives_and_question_sets(self) -> None:
        ...
        for phrase in (
            ...
            "internal quality rubric",
            "direct conclusion",
            "connected paragraphs",
            "shown and answered separately",
            "relationship among the evidence anchors",
            "15-20",
            "strongest two outputs",
            "summarize remaining verified outputs",
        ...
        for retired_phrase in (
            ...
            "Every question must be a complete unit containing",
            "`Detailed question`",
            "`Interview intent`",
            "`Reasoning process`",
    ...
    def test_role_analysis_framework_maps_evidence_to_career_material(self) -> None:
        ...
        for phrase in (
            ...
            "final quality audit",
            "glossary",
            "causal problem narrative",
            "architecture and call-path map",
            "state, data, protocol, or lifecycle model",
            "happy, failure, recovery, and degradation paths",
            "code and test responsibility map",
            "evidence gaps",
        ):
